...
This document is primarily a historical audit trail. Many issues below were
fixed after the initial write-up; use the closing summary and `docs/status.md`
as the authoritative view of the current state.
