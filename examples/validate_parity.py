...
def validate_diffusion_module(
    ...
    *,
    ...
    from chai_mlx.config import ChaiConfig
    from chai_mlx.io.weights.name_map import _diffusion_module_map, reshape_einsum_weight
...
def validate_edm_schedule(*, tol: float = 1e-6) -> list[ParityResult]:
    ...
    from chai_mlx.utils import edm_sigmas, edm_gammas
...
def validate_trunk_weight_mapping(
    ...
    *,
    ...
    from chai_mlx.config import ChaiConfig
    from chai_mlx.io.weights.name_map import _trunk_map, reshape_einsum_weight
...
def validate_utilities(*, tol: float = 1e-6) -> list[ParityResult]:
    ...
    from chai_mlx.utils import one_hot_binned, stable_softmax, pairwise_distance
