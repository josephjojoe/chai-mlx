...
from .layers.attention import DiffusionSelfAttention
from .layers.atom_attention import DiffusionAtomAttentionDecoder, DiffusionAtomAttentionEncoder
from .layers.common import ConditionedTransition, Transition
from .types import DiffusionCache, StructureInputs, TrunkOutputs
from .utils import (
...
class DiffusionConditioning(nn.Module):
    def __init__(self, cfg: Chai1Config) -> None:
        ...
        self.pair_trans1 = Transition(cfg.hidden.token_pair, expansion=2, bias_out=True, eps=cfg.layer_norm_eps)
        self.pair_trans2 = Transition(cfg.hidden.token_pair, expansion=2, bias_out=True, eps=cfg.layer_norm_eps)
        ...
        self.single_trans1 = Transition(cfg.hidden.token_single, expansion=2, bias_out=True, eps=cfg.layer_norm_eps)
        self.single_trans2 = Transition(cfg.hidden.token_single, expansion=2, bias_out=True, eps=cfg.layer_norm_eps)
